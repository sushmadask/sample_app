! function(a, b) {
    ...
    angular.module("textAngularSetup", []).constant("taRegisterTool", d).value("taTools", e).value("taOptions", {
            ...
            angular.forEach(["h1", "h2", "h3", "h4", "h5", "h6"], function(b) {
                ...
                display: '<div id="toolbarWC" style="display:block; min-width:100px;">Words: <span style="font-weight:bold;" ng-bind="wordcount"></span></div>',
                disabled: !0,
                wordcount: 0,
                activeState: function() {
                ...
                display: '<div id="toolbarWR" style="display:block; min-width:100px;">Rem Words: <span style="font-weight:bold;" ng-bind="remword"></span></div>',
                disabled: !0,
                remword: 120,
                activeState: function() {
                    var a = this.$editor().displayElements.text,
                        ...
                        maxword = 120,
                        c = 0;
                    return "" !== b.replace(/\s*<[^>]*?>\s*/g, "") && (c = b.replace(/<\/?(b|i|em|strong|span|u|strikethrough|a|img|small|sub|sup|label)( [^>*?])?>/gi, "").replace(/(<[^>]*?>\s*<[^>]*?>)/gi, " ").replace(/(<[^>]*?>)/gi, "").replace(/\s+/gi, " ").match(/\S+/g).length), this.remword = maxword-c, this.$editor().remword = maxword-c, !1
                }
            })
        }]),
        /*
